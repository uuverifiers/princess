...
CLASSPATH:=$(CLASSPATH):$(BASEDIR)/parser/parser.jar:$(BASEDIR)/smt-parser/smt-parser.jar:$(EXTLIBSDIR)/java-cup-11a.jar:$(EXTLIBSDIR)/ccu.jar:$(EXTLIBSDIR)/org.sat4j.core.jar
