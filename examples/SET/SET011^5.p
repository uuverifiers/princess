%------------------------------------------------------------------------------
% File     : SET011^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-82
% Version  : Especial.
% English  : Trybulec's 82nd Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0212 [Bro09]
%          : BOOL-PROP-82 [TPS]
...
%            Number of connectives :   10 (   2   ~;   0   |;   3   &;   5   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_82_pme,conjecture,(
    ! [X: a > $o,Y: a > $o] :
      ( ( ^ [Xx: a] :
            ( ( X @ Xx )
            & ~ ( ( X @ Xx )
