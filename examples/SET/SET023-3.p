%--------------------------------------------------------------------------
% File     : SET023-3 : TPTP v6.1.0. Released v1.0.0.
% Domain   : Set Theory
...
% Rating   : 0.20 v6.1.0, 0.36 v6.0.0, 0.30 v5.5.0, 0.65 v5.4.0, 0.60 v5.3.0, 0.67 v5.2.0, 0.56 v5.1.0, 0.65 v5.0.0, 0.50 v4.1.0, 0.46 v4.0.1, 0.45 v4.0.0, 0.36 v3.7.0, 0.10 v3.5.0, 0.27 v3.4.0, 0.42 v3.3.0, 0.43 v3.2.0, 0.54 v3.1.0, 0.27 v2.7.0, 0.42 v2.6.0, 0.40 v2.5.0, 0.58 v2.4.0, 0.44 v2.3.0, 0.56 v2.2.1, 0.67 v2.2.0, 0.67 v2.1.0, 0.89 v2.0.0
% Syntax   : Number of clauses     :  150 (  20 non-Horn;  13 unit; 127 RR)
%            Number of atoms       :  382 (  56 equality)
%            Maximal clause size   :    8 (   3 average)
%            Number of predicates  :   14 (   0 propositional; 1-5 arity)
%            Number of functors    :   60 (   7 constant; 0-5 arity)
%            Number of variables   :  338 (  30 singleton)
