%--------------------------------------------------------------------------
% File     : SET030-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v1.2.1 - Fixed prove_application_property8_1.
...
%--------------------------------------------------------------------------
cnf(prove_application_property8_1,negated_conjecture,
    ( single_valued_class(xf) )).

cnf(prove_application_property8_2,negated_conjecture,
    ( ~ member(apply(xf,x),universal_class) )).
