%--------------------------------------------------------------------------
% File     : SET032-3 : TPTP v6.1.0. Released v1.0.0.
% Domain   : Set Theory
...
% Rating   : 0.90 v6.1.0, 1.00 v6.0.0, 0.90 v5.5.0, 1.00 v4.1.0, 0.92 v4.0.1, 1.00 v2.0.0
% Syntax   : Number of clauses     :  158 (  20 non-Horn;  16 unit; 130 RR)
%            Number of atoms       :  396 (  56 equality)
%            Maximal clause size   :    8 (   3 average)
%            Number of predicates  :   14 (   0 propositional; 1-5 arity)
%            Number of functors    :   61 (   8 constant; 0-5 arity)
%            Number of variables   :  354 (  35 singleton)
