%--------------------------------------------------------------------------
% File     : SET037-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v1.2.1 - Fixed prove_application_property10_1.
...
%--------------------------------------------------------------------------
cnf(prove_application_property10_1,negated_conjecture,
    ( single_valued_class(xf) )).

cnf(prove_application_property10_2,negated_conjecture,
    ( member(x,domain_of(xf)) )).

cnf(prove_application_property10_3,negated_conjecture,
    ( ~ member(ordered_pair(x,apply(xf,x)),xf) )).
