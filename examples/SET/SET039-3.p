%--------------------------------------------------------------------------
% File     : SET039-3 : TPTP v6.1.0. Released v1.0.0.
% Domain   : Set Theory
...
% Rating   : 0.90 v6.1.0, 1.00 v6.0.0, 0.80 v5.5.0, 0.95 v5.3.0, 0.94 v5.2.0, 1.00 v4.0.1, 0.91 v3.7.0, 0.90 v3.5.0, 0.91 v3.4.0, 0.92 v3.3.0, 0.93 v3.2.0, 0.92 v3.1.0, 1.00 v2.0.0
% Syntax   : Number of clauses     :  167 (  20 non-Horn;  19 unit; 138 RR)
%            Number of atoms       :  419 (  59 equality)
%            Maximal clause size   :    8 (   3 average)
%            Number of predicates  :   14 (   0 propositional; 1-5 arity)
%            Number of functors    :   62 (   9 constant; 0-5 arity)
%            Number of variables   :  375 (  36 singleton)
