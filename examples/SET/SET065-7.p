%--------------------------------------------------------------------------
% File     : SET065-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : The null class is a set
...
% Rating   : 0.10 v6.1.0, 0.07 v6.0.0, 0.00 v5.5.0, 0.15 v5.3.0, 0.11 v5.2.0, 0.12 v5.0.0, 0.07 v4.1.0, 0.08 v4.0.1, 0.27 v3.7.0, 0.30 v3.5.0, 0.27 v3.4.0, 0.17 v3.3.0, 0.00 v2.1.0
% Syntax   : Number of clauses     :  107 (  12 non-Horn;  34 unit;  74 RR)
%            Number of atoms       :  213 (  45 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   38 (   8 constant; 0-3 arity)
%            Number of variables   :  210 (  38 singleton)
