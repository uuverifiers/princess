%------------------------------------------------------------------------------
% File     : SET067-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Rating   : 0.40 v6.1.0, 0.43 v6.0.0, 0.40 v5.5.0, 0.75 v5.4.0, 0.65 v5.3.0, 0.72 v5.2.0, 0.69 v5.1.0, 0.76 v5.0.0, 0.79 v4.1.0, 0.77 v4.0.1, 0.73 v4.0.0, 0.64 v3.7.0, 0.40 v3.5.0, 0.55 v3.4.0, 0.50 v3.2.0, 0.46 v3.1.0, 0.27 v2.7.0, 0.50 v2.6.0, 0.44 v2.5.0, 0.45 v2.4.0, 0.25 v2.3.0, 0.38 v2.2.1, 0.33 v2.2.0, 0.33 v2.1.0
% Syntax   : Number of clauses     :  109 (  12 non-Horn;  36 unit;  75 RR)
