%--------------------------------------------------------------------------
% File     : SET091-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Member_of(X) is unique if X is not a singleton, part 1
...
% Status   : Unknown
% Rating   : 1.00 v2.1.0
% Syntax   : Number of clauses     :  136 (  19 non-Horn;  42 unit;  92 RR)
%            Number of atoms       :  271 (  72 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   41 (   9 constant; 0-3 arity)
%            Number of variables   :  259 (  46 singleton)
...
cnf(prove_member_of_non_singleton_unique1_1,negated_conjecture,
    ( ~ member(member_of1(x),universal_class) )).

cnf(prove_member_of_non_singleton_unique1_2,negated_conjecture,
    (  member_of(x) != x )).
