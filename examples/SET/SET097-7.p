%--------------------------------------------------------------------------
% File     : SET097-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Rating   : 0.50 v6.1.0, 0.64 v6.0.0, 0.60 v5.5.0, 0.85 v5.3.0, 0.89 v5.2.0, 0.75 v5.1.0, 0.76 v5.0.0, 0.86 v4.1.0, 0.77 v4.0.1, 0.73 v3.7.0, 0.60 v3.5.0, 0.64 v3.4.0, 0.75 v3.3.0, 0.79 v3.2.0, 0.85 v3.1.0, 0.73 v2.7.0, 0.92 v2.6.0, 1.00 v2.5.0, 0.91 v2.4.0, 1.00 v2.1.0
% Syntax   : Number of clauses     :  143 (  22 non-Horn;  43 unit;  97 RR)
%            Number of atoms       :  286 (  81 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   41 (   9 constant; 0-3 arity)
%            Number of variables   :  268 (  46 singleton)
