%--------------------------------------------------------------------------
% File     : SET098-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Source   : [Quaife]
% Names    : SS13 cor.1 [Qua92]

% Status   : Unsatisfiable
% Rating   : 0.30 v6.1.0, 0.29 v6.0.0, 0.30 v5.5.0, 0.70 v5.3.0, 0.72 v5.2.0, 0.56 v5.1.0, 0.59 v5.0.0, 0.50 v4.1.0, 0.62 v4.0.1, 0.55 v3.7.0, 0.40 v3.5.0, 0.45 v3.4.0, 0.50 v3.2.0, 0.46 v3.1.0, 0.36 v2.7.0, 0.33 v2.5.0, 0.64 v2.4.0, 0.38 v2.3.0, 0.12 v2.2.1, 0.33 v2.2.0, 0.00 v2.1.0
% Syntax   : Number of clauses     :  144 (  23 non-Horn;  43 unit;  97 RR)
%            Number of atoms       :  289 (  83 equality)
