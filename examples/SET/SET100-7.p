%--------------------------------------------------------------------------
% File     : SET100-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Status   : Unknown
% Rating   : 1.00 v2.1.0
% Syntax   : Number of clauses     :  144 (  25 non-Horn;  41 unit;  96 RR)
%            Number of atoms       :  293 (  87 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   42 (  10 constant; 0-3 arity)
%            Number of variables   :  271 (  46 singleton)
