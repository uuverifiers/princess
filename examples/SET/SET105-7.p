%--------------------------------------------------------------------------
% File     : SET105-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Rating   : 0.40 v6.1.0, 0.50 v5.5.0, 0.70 v5.3.0, 0.72 v5.2.0, 0.62 v5.1.0, 0.65 v5.0.0, 0.64 v4.1.0, 0.62 v4.0.1, 0.55 v4.0.0, 0.45 v3.7.0, 0.40 v3.5.0, 0.45 v3.4.0, 0.42 v3.3.0, 0.50 v3.2.0, 0.54 v3.1.0, 0.45 v2.7.0, 0.50 v2.6.0, 0.44 v2.5.0, 0.45 v2.4.0, 0.38 v2.2.1, 0.50 v2.2.0, 0.33 v2.1.0
% Syntax   : Number of clauses     :  150 (  25 non-Horn;  47 unit;  98 RR)
%            Number of atoms       :  299 (  88 equality)
