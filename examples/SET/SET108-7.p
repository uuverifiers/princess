%--------------------------------------------------------------------------
% File     : SET108-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Rating   : 0.10 v6.1.0, 0.14 v6.0.0, 0.20 v5.5.0, 0.35 v5.3.0, 0.33 v5.2.0, 0.31 v5.1.0, 0.29 v5.0.0, 0.14 v4.1.0, 0.23 v4.0.1, 0.36 v3.7.0, 0.20 v3.5.0, 0.27 v3.4.0, 0.17 v3.3.0, 0.21 v3.2.0, 0.08 v3.1.0, 0.09 v2.7.0, 0.08 v2.6.0, 0.00 v2.5.0, 0.18 v2.4.0, 0.38 v2.3.0, 0.25 v2.2.1, 0.17 v2.2.0, 0.00 v2.1.0
% Syntax   : Number of clauses     :  154 (  28 non-Horn;  46 unit;  99 RR)
%            Number of atoms       :  312 (  94 equality)
...
%          : In [Qua92b] there is another problem like this. The clause is
%            given below.
