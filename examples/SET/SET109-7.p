%--------------------------------------------------------------------------
% File     : SET109-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : 1st is the ordered pair, first condition
...
%            Number of atoms       :  312 (  95 equality)
...
cnf(prove_existence_of_1st_and_2nd_2_1,negated_conjecture,
    ( ~ member(ordered_pair(first(x),second(x)),cross_product(universal_class,universal_class)) )).

cnf(prove_existence_of_1st_and_2nd_2_2,negated_conjecture,
    (  first(x) != x )).
