%--------------------------------------------------------------------------
% File     : SET112-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_existence_of_1st_and_2nd_5_1,negated_conjecture,
    (  ordered_pair(first(x),second(x)) != x )).

cnf(prove_existence_of_1st_and_2nd_5_2,negated_conjecture,
    (  second(x) != x )).
