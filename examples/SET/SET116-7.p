%--------------------------------------------------------------------------
% File     : SET116-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : 2nd is unique if x is not an ordered pair of sets, part 2
...
% Status   : Unknown
% Rating   : 1.00 v2.1.0
% Syntax   : Number of clauses     :  161 (  32 non-Horn;  46 unit; 102 RR)
%            Number of atoms       :  326 ( 104 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   43 (   9 constant; 0-3 arity)
%            Number of variables   :  303 (  53 singleton)
