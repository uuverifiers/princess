%--------------------------------------------------------------------------
% File     : SET119-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Source   : [Quaife]
% Names    : OP10 cor.1 [Qua92]

% Status   : Unsatisfiable
% Rating   : 0.20 v6.1.0, 0.29 v6.0.0, 0.20 v5.5.0, 0.70 v5.3.0, 0.67 v5.2.0, 0.56 v5.1.0, 0.65 v5.0.0, 0.64 v4.1.0, 0.69 v4.0.1, 0.55 v3.7.0, 0.30 v3.5.0, 0.45 v3.4.0, 0.50 v3.3.0, 0.43 v3.2.0, 0.31 v3.1.0, 0.36 v2.7.0, 0.42 v2.6.0, 0.33 v2.5.0, 0.36 v2.4.0, 0.25 v2.2.1, 0.50 v2.2.0, 0.33 v2.1.0
% Syntax   : Number of clauses     :  167 (  36 non-Horn;  46 unit; 104 RR)
%            Number of atoms       :  338 ( 110 equality)
...
cnf(prove_corollary_1_to_OP_determines_components1_1,negated_conjecture,
    ( ~ member(x,universal_class) )).

cnf(prove_corollary_1_to_OP_determines_components1_2,negated_conjecture,
