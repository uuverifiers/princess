%--------------------------------------------------------------------------
% File     : SET122-7 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
% Source   : [Quaife]
% Names    : OP11 cor.2 [Qua92]

% Status   : Unsatisfiable
% Rating   : 0.20 v6.1.0, 0.29 v6.0.0, 0.20 v5.5.0, 0.70 v5.3.0, 0.72 v5.2.0, 0.56 v5.1.0, 0.65 v5.0.0, 0.64 v4.1.0, 0.69 v4.0.1, 0.55 v4.0.0, 0.64 v3.7.0, 0.30 v3.5.0, 0.45 v3.4.0, 0.50 v3.3.0, 0.43 v3.2.0, 0.31 v3.1.0, 0.36 v2.7.0, 0.42 v2.6.0, 0.33 v2.5.0, 0.36 v2.4.0, 0.25 v2.2.1, 0.50 v2.2.0, 0.33 v2.1.0
% Syntax   : Number of clauses     :  169 (  38 non-Horn;  46 unit; 104 RR)
%            Number of atoms       :  342 ( 112 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   44 (  10 constant; 0-3 arity)
%            Number of variables   :  313 (  53 singleton)
...
cnf(corollary_2_to_ordered_pairs_are_sets,axiom,
...
%----corollaries.
cnf(corollary_1_to_ordered_pair_determines_components1,axiom,
    ( member(X,universal_class)
    | first(ordered_pair(X,Y)) = ordered_pair(X,Y) )).

cnf(corollary_2_to_ordered_pair_determines_components1,axiom,
    ( member(X,universal_class)
