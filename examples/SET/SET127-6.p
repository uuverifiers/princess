%--------------------------------------------------------------------------
% File     : SET127-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Relation to unordered pair
...
cnf(prove_set_builder_and_unordered_pair_1,negated_conjecture,
    (  set_builder(x,singleton(y)) != unordered_pair(x,y) )).
