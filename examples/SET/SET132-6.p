%--------------------------------------------------------------------------
% File     : SET132-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Membership in unordered triple, part 3
...
% Rating   : 0.60 v6.1.0, 0.57 v6.0.0, 0.70 v5.5.0, 0.85 v5.3.0, 0.89 v5.2.0, 0.81 v5.1.0, 0.76 v5.0.0, 0.71 v4.1.0, 0.77 v4.0.1, 0.82 v4.0.0, 0.73 v3.7.0, 0.70 v3.5.0, 0.82 v3.4.0, 0.83 v3.3.0, 0.79 v3.2.0, 0.77 v3.1.0, 0.82 v2.7.0, 0.83 v2.6.0, 0.67 v2.5.0, 0.73 v2.4.0, 0.38 v2.3.0, 0.50 v2.2.1, 0.83 v2.2.0, 0.67 v2.1.0
...
cnf(prove_member_of_triple3_1,negated_conjecture,
    ( member(u,universal_class) )).

cnf(prove_member_of_triple3_2,negated_conjecture,
    ( ~ member(u,set_builder(x,set_builder(y,set_builder(u,null_class)))) )).
