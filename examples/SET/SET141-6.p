%--------------------------------------------------------------------------
% File     : SET141-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Triple reduction 3
...
cnf(prove_triple_reduction3_1,negated_conjecture,
    (  set_builder(x,set_builder(y,set_builder(y,null_class))) != unordered_pair(x,y) )).
