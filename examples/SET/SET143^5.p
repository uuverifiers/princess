%------------------------------------------------------------------------------
% File     : SET143^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-67
% Version  : Especial.
% English  : Trybulec's 67th Boolean property of sets
...
%            Number of connectives :   10 (   0   ~;   0   |;   4   &;   6   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_67_pme,conjecture,(
    ! [X: a > $o,Y: a > $o,Z: a > $o] :
      ( ( ^ [Xx: a] :
            ( ( X @ Xx )
            & ( Y @ Xx )
