%--------------------------------------------------------------------------
% File     : SET169-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_intersection_over_union1_1,negated_conjecture,
    (  union(intersection(x,y),intersection(x,z)) != intersection(x,union(y,z)) )).
