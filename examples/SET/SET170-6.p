%--------------------------------------------------------------------------
% File     : SET170-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Distribution of intersection over union 2
...
%--------------------------------------------------------------------------
cnf(prove_intersection_over_union2_1,negated_conjecture,
    (  union(intersection(x,z),intersection(y,z)) != intersection(union(x,y),z) )).
