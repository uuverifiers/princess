%------------------------------------------------------------------------------
% File     : SET171^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-71
% Version  : Especial.
% English  : Trybulec's 71st Boolean property of sets
...
%            Number of connectives :   12 (   0   ~;   3   |;   2   &;   7   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_71_pme,conjecture,(
    ! [X: a > $o,Y: a > $o,Z: a > $o] :
      ( ( ^ [Xz: a] :
            ( ( X @ Xz )
            | ( ( Y @ Xz )
