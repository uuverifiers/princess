%--------------------------------------------------------------------------
% File     : SET176-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to absorbtion for union
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_absorbtion_for_union_1,negated_conjecture,
    (  union(x,union(y,intersection(x,z))) != union(x,y) )).
