%--------------------------------------------------------------------------
% File     : SET177-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Distribution property 1
...
%--------------------------------------------------------------------------
cnf(prove_distribution_property1_1,negated_conjecture,
    (  union(x,intersection(complement(x),z)) != union(x,z) )).
