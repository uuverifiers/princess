%--------------------------------------------------------------------------
% File     : SET178-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to distribution property 1
...
%--------------------------------------------------------------------------
cnf(prove_corollary_1_to_distribution_property1_1,negated_conjecture,
    (  union(x,union(y,intersection(complement(x),z))) != union(x,union(y,z)) )).
