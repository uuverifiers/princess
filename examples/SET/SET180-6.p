%--------------------------------------------------------------------------
% File     : SET180-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Distribution property 2
...
%--------------------------------------------------------------------------
cnf(prove_distribution_property2_1,negated_conjecture,
    (  union(complement(x),intersection(x,z)) != union(complement(x),z) )).
