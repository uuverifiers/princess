%--------------------------------------------------------------------------
% File     : SET181-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to distribution property 2
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_distribution_property2_1,negated_conjecture,
    (  union(complement(x),union(y,intersection(x,z))) != union(complement(x),union(y,z)) )).
