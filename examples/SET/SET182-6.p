%--------------------------------------------------------------------------
% File     : SET182-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Distribution property 3
...
%--------------------------------------------------------------------------
cnf(prove_distribution_property3_1,negated_conjecture,
    (  union(intersection(complement(x),y),intersection(x,y)) != y )).
