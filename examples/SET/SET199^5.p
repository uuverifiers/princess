%------------------------------------------------------------------------------
% File     : SET199^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-39
% Version  : Especial.
% English  : Trybulec's 39th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0150 [Bro09]
%          : BOOL-PROP-39 [TPS]
...
thf(cBOOL_PROP_39_pme,conjecture,(
    ! [X: a > $o,Y: a > $o,Z: a > $o] :
      ( ( ! [Xx: a] :
            ( ( Z @ Xx )
           => ( X @ Xx ) )
