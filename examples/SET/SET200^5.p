%------------------------------------------------------------------------------
% File     : SET200^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-34
% Version  : Especial.
% English  : Trybulec's 34th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0154 [Bro09]
%          : BOOL-PROP-34 [TPS]
...
%            Number of connectives :   15 (   0   ~;   2   |;   1   &;   8   @)
%                                         (   0 <=>;   4  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_34_pme,conjecture,(
