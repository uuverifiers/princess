%--------------------------------------------------------------------------
% File     : SET210-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to cross product product monotonicity
...
%--------------------------------------------------------------------------
cnf(prove_corollary_1_to_X_product_monotonicity_1,negated_conjecture,
    ( ~ subclass(cross_product(x,z),cross_product(union(x,y),z)) )).
