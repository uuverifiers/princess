%--------------------------------------------------------------------------
% File     : SET216-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 7 to cross product product monotonicity
...
%--------------------------------------------------------------------------
cnf(prove_corollary_7_to_X_product_monotonicity_1,negated_conjecture,
