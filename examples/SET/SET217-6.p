%--------------------------------------------------------------------------
% File     : SET217-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 8 to cross product product monotonicity
...
%--------------------------------------------------------------------------
cnf(prove_corollary_8_to_X_product_monotonicity_1,negated_conjecture,
    ( ~ subclass(cross_product(x,intersection(y,z)),cross_product(x,z)) )).
