%--------------------------------------------------------------------------
% File     : SET218-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Cross product distributes over union 1
...
%--------------------------------------------------------------------------
cnf(prove_cross_product_over_union1_1,negated_conjecture,
    (  union(cross_product(x,z),cross_product(y,z)) != cross_product(union(x,y),z) )).
