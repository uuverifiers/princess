%--------------------------------------------------------------------------
% File     : SET219-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Cross product distributes over union 2
...
%--------------------------------------------------------------------------
cnf(prove_cross_product_over_union2_1,negated_conjecture,
    (  union(cross_product(x,y),cross_product(x,z)) != cross_product(x,union(y,z)) )).
