%--------------------------------------------------------------------------
% File     : SET224-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Cross product double distribution for intersection
...
%--------------------------------------------------------------------------
cnf(prove_cross_product_double_distribution_1,negated_conjecture,
    (  intersection(cross_product(w,x),cross_product(y,z)) != cross_product(intersection(w,y),intersection(x,z)) )).
