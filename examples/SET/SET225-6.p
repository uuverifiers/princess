%--------------------------------------------------------------------------
% File     : SET225-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse of cross product squared
...
%--------------------------------------------------------------------------
cnf(prove_inverse_of_square_1,negated_conjecture,
    (  inverse(cross_product(x,x)) != cross_product(x,x) )).
