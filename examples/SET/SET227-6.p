%--------------------------------------------------------------------------
% File     : SET227-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Cross product left cancellation 2
...
%--------------------------------------------------------------------------
cnf(prove_cross_product_left_cancellation2_1,negated_conjecture,
    ( cross_product(u,v) = cross_product(w,x) )).

cnf(prove_cross_product_left_cancellation2_2,negated_conjecture,
    (  w != null_class )).

cnf(prove_cross_product_left_cancellation2_3,negated_conjecture,
    (  v != x )).
