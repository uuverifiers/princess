%--------------------------------------------------------------------------
% File     : SET229-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Cross product right cancellation 2
...
%--------------------------------------------------------------------------
cnf(prove_cross_product_right_cancellation2_1,negated_conjecture,
    ( cross_product(u,v) = cross_product(w,x) )).

cnf(prove_cross_product_right_cancellation2_2,negated_conjecture,
    (  x != null_class )).

cnf(prove_cross_product_right_cancellation2_3,negated_conjecture,
    (  u != w )).
