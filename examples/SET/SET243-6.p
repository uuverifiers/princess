%--------------------------------------------------------------------------
% File     : SET243-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Restriction property 1
...
%--------------------------------------------------------------------------
cnf(prove_restriction_property1_1,negated_conjecture,
    (  restrict(restrict(xf,x1,y1),x2,y2) != restrict(xf,intersection(x1,x2),intersection(y1,y2)) )).
