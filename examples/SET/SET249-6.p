%--------------------------------------------------------------------------
% File     : SET249-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Restriction property 2
...
%--------------------------------------------------------------------------
cnf(prove_restriction_property2_1,negated_conjecture,
    (  union(restrict(xr1,x,y),restrict(xr2,x,y)) != restrict(union(xr1,xr2),x,y) )).
