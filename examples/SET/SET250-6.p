%--------------------------------------------------------------------------
% File     : SET250-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to restriction property 2
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_restriction_property2_1,negated_conjecture,
    (  union(restrict(x,y,y),inverse(restrict(x,y,y))) != restrict(union(x,inverse(x)),y,y) )).
