%--------------------------------------------------------------------------
% File     : SET265-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain is monotonic 2
...
%--------------------------------------------------------------------------
cnf(prove_domain_is_monotonic2_1,negated_conjecture,
    ( ~ subclass(domain_of(intersection(x,y)),domain_of(x)) )).
