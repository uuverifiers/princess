%--------------------------------------------------------------------------
% File     : SET270-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain property 2
...
%--------------------------------------------------------------------------
cnf(prove_domain_property2_1,negated_conjecture,
    (  domain_of(cross_product(x,y)) != x )).

cnf(prove_domain_property2_2,negated_conjecture,
    (  y != null_class )).
