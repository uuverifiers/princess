%--------------------------------------------------------------------------
% File     : SET271-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to domain property 2
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_domain_property2_1,negated_conjecture,
    (  domain_of(cross_product(x,x)) != x )).
