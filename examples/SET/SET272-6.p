%--------------------------------------------------------------------------
% File     : SET272-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain property 3
...
%--------------------------------------------------------------------------
cnf(prove_domain_property3_1,negated_conjecture,
    (  restrict(xr,intersection(domain_of(xr),x),y) != restrict(xr,x,y) )).
