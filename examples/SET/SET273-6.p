%--------------------------------------------------------------------------
% File     : SET273-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to domain property 3
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_domain_property3_1,negated_conjecture,
    (  restrict(xr,domain_of(xr),y) != restrict(xr,universal_class,y) )).
