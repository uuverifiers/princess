%--------------------------------------------------------------------------
% File     : SET274-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain property 4
...
%--------------------------------------------------------------------------
cnf(prove_domain_property4_1,negated_conjecture,
    (  domain_of(restrict(x,y,universal_class)) != intersection(domain_of(x),y) )).
