%--------------------------------------------------------------------------
% File     : SET275-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to domain property 4
...
%--------------------------------------------------------------------------
cnf(prove_corollary_1_to_domain_property4_1,negated_conjecture,
    ( ~ subclass(domain_of(restrict(x,y,z)),intersection(domain_of(x),y)) )).
