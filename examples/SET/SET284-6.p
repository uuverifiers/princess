%--------------------------------------------------------------------------
% File     : SET284-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image of domain relation
...
%--------------------------------------------------------------------------
cnf(prove_image_of_domain_relation_1,negated_conjecture,
    (  sum_class(image(domain_relation,x)) != domain_of(sum_class(x)) )).
