%--------------------------------------------------------------------------
% File     : SET285-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain property 7
...
%--------------------------------------------------------------------------
cnf(prove_domain_property7_1,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_domain_property7_2,negated_conjecture,
