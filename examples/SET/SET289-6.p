%--------------------------------------------------------------------------
% File     : SET289-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Proof of Goedel's axiom B6, part 1
...
%--------------------------------------------------------------------------
cnf(prove_inverse_property1_1,negated_conjecture,
    ( ~ subclass(inverse(x),cross_product(universal_class,universal_class)) )).
