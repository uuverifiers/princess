%--------------------------------------------------------------------------
% File     : SET290-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Proof of Goedel's axiom B6, part 2
...
%--------------------------------------------------------------------------
cnf(prove_inverse_property2_1,negated_conjecture,
    ( member(ordered_pair(u,v),inverse(x)) )).

cnf(prove_inverse_property2_2,negated_conjecture,
