%--------------------------------------------------------------------------
% File     : SET292-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse of null class is the null class
...
%--------------------------------------------------------------------------
cnf(prove_inverse_of_null_class_1,negated_conjecture,
    (  inverse(null_class) != null_class )).
