%--------------------------------------------------------------------------
% File     : SET293-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse of universal class is the universal class
...
%--------------------------------------------------------------------------
cnf(prove_inverse_of_universal_class_1,negated_conjecture,
