%--------------------------------------------------------------------------
% File     : SET294-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse distributes over union
...
%--------------------------------------------------------------------------
cnf(prove_inverse_over_union_1,negated_conjecture,
    (  union(inverse(x),inverse(y)) != inverse(union(x,y)) )).
