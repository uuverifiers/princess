%--------------------------------------------------------------------------
% File     : SET295-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse distributes over intersection
...
%--------------------------------------------------------------------------
cnf(prove_inverse_over_intersection_1,negated_conjecture,
    (  intersection(inverse(x),inverse(y)) != inverse(intersection(x,y)) )).
