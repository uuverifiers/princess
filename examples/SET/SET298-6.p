%--------------------------------------------------------------------------
% File     : SET298-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse of complement
...
%--------------------------------------------------------------------------
cnf(prove_inverse_of_complement_1,negated_conjecture,
    (  inverse(complement(x)) != intersection(complement(inverse(x)),cross_product(universal_class,universal_class)) )).
