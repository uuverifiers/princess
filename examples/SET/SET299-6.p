%--------------------------------------------------------------------------
% File     : SET299-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse of product
...
%--------------------------------------------------------------------------
cnf(prove_inverse_of_product_1,negated_conjecture,
    (  inverse(cross_product(x,y)) != cross_product(y,x) )).
