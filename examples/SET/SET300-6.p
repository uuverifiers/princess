%--------------------------------------------------------------------------
% File     : SET300-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse of inverse
...
%--------------------------------------------------------------------------
cnf(prove_inverse_of_inverse_1,negated_conjecture,
    (  inverse(inverse(x)) != restrict(x,universal_class,universal_class) )).
