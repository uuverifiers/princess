%--------------------------------------------------------------------------
% File     : SET301-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Inverse commutes with restriction
...
%--------------------------------------------------------------------------
cnf(prove_inverse_commutes_restriction_1,negated_conjecture,
    (  inverse(restrict(xr,y,x)) != restrict(inverse(xr),x,y) )).
