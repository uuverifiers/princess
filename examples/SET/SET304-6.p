%--------------------------------------------------------------------------
% File     : SET304-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range alternate definition 3
...
%--------------------------------------------------------------------------
cnf(prove_range_alternate_defn3_1,negated_conjecture,
    ( member(ordered_pair(x,y),xr) )).

cnf(prove_range_alternate_defn3_2,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_range_alternate_defn3_3,negated_conjecture,
