%--------------------------------------------------------------------------
% File     : SET307-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range preserves union
...
%--------------------------------------------------------------------------
cnf(prove_range_preserves_union_1,negated_conjecture,
    (  union(range_of(x),range_of(y)) != range_of(union(x,y)) )).
