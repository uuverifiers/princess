%--------------------------------------------------------------------------
% File     : SET308-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of range 1
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_range1_1,negated_conjecture,
    ( subclass(x,y) )).

cnf(prove_monotonicity_of_range1_2,negated_conjecture,
    ( ~ subclass(range_of(x),range_of(y)) )).
