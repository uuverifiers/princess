%--------------------------------------------------------------------------
% File     : SET310-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of range 3
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_range3_1,negated_conjecture,
    ( ~ subclass(range_of(intersection(x,y)),range_of(x)) )).
