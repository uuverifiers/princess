%--------------------------------------------------------------------------
% File     : SET311-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range property 1
...
%--------------------------------------------------------------------------
cnf(prove_range_property1_1,negated_conjecture,
    ( ~ subclass(intersection(x,cross_product(universal_class,universal_class)),cross_product(universal_class,range_of(x))) )).
