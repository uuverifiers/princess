%--------------------------------------------------------------------------
% File     : SET312-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range only considers ordered pairs
...
%--------------------------------------------------------------------------
cnf(prove_range_does_ordered_pairs_1,negated_conjecture,
    (  range_of(intersection(x,cross_product(universal_class,universal_class))) != range_of(x) )).
