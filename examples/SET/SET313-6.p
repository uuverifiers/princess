%--------------------------------------------------------------------------
% File     : SET313-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range property 2
...
%--------------------------------------------------------------------------
cnf(prove_range_property2_1,negated_conjecture,
    (  range_of(cross_product(x,y)) != y )).

cnf(prove_range_property2_2,negated_conjecture,
    (  x != null_class )).
