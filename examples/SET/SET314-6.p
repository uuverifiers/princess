%--------------------------------------------------------------------------
% File     : SET314-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range property 3
...
%--------------------------------------------------------------------------
cnf(prove_range_property3_1,negated_conjecture,
    (  restrict(xr,x,intersection(y,range_of(xr))) != restrict(xr,x,y) )).
