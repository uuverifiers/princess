%--------------------------------------------------------------------------
% File     : SET315-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to range property 3
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_range_property3_1,negated_conjecture,
    (  restrict(xr,x,range_of(xr)) != restrict(xr,x,universal_class) )).
