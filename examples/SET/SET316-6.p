%--------------------------------------------------------------------------
% File     : SET316-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range property 4
...
%--------------------------------------------------------------------------
cnf(prove_range_property4_1,negated_conjecture,
    (  range_of(restrict(x,universal_class,z)) != intersection(range_of(x),z) )).
