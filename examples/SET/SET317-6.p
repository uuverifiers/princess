%--------------------------------------------------------------------------
% File     : SET317-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to range property 4
...
%--------------------------------------------------------------------------
cnf(prove_corollary_1_to_range_property4_1,negated_conjecture,
    ( ~ subclass(range_of(restrict(x,y,z)),intersection(z,range_of(x))) )).
