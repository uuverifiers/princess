%--------------------------------------------------------------------------
% File     : SET321-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range property 5
...
%--------------------------------------------------------------------------
cnf(prove_range_property5_1,negated_conjecture,
    ( member(y,range_of(z)) )).

cnf(prove_range_property5_2,negated_conjecture,
    ( ~ member(domain(z,universal_class,y),domain_of(z)) )).
