%--------------------------------------------------------------------------
% File     : SET322-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range property 6
...
%--------------------------------------------------------------------------
cnf(prove_range_property6_1,negated_conjecture,
    ( member(x,domain_of(z)) )).

cnf(prove_range_property6_2,negated_conjecture,
    ( ~ member(range(z,x,universal_class),range_of(z)) )).
