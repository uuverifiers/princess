%--------------------------------------------------------------------------
% File     : SET325-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image alternate definition 2
...
%--------------------------------------------------------------------------
cnf(prove_image_alternate_defn2_1,negated_conjecture,
    ( member(y,image(xr,x)) )).

cnf(prove_image_alternate_defn2_2,negated_conjecture,
    ( ~ member(ordered_pair(domain(xr,x,y),y),xr) )).
