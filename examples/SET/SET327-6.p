%--------------------------------------------------------------------------
% File     : SET327-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image alternate definition 3
...
%--------------------------------------------------------------------------
cnf(prove_image_alternate_defn3_1,negated_conjecture,
    ( member(y,image(xr,x)) )).

cnf(prove_image_alternate_defn3_2,negated_conjecture,
    ( ~ member(domain(xr,x,y),x) )).
