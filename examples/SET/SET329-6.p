%--------------------------------------------------------------------------
% File     : SET329-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image alternate definition 4
...
%--------------------------------------------------------------------------
cnf(prove_image_alternate_defn4_1,negated_conjecture,
    ( member(ordered_pair(x,y),xr) )).

cnf(prove_image_alternate_defn4_2,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_image_alternate_defn4_3,negated_conjecture,
    ( member(x,z) )).

cnf(prove_image_alternate_defn4_4,negated_conjecture,
    ( ~ member(y,image(xr,z)) )).
