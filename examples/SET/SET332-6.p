%--------------------------------------------------------------------------
% File     : SET332-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to range is image of domain
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_image_of_domain_1,negated_conjecture,
    (  image(xr,universal_class) != range_of(xr) )).
