%--------------------------------------------------------------------------
% File     : SET333-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of image 1
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_image1_1,negated_conjecture,
    ( subclass(y,z) )).

cnf(prove_monotonicity_of_image1_2,negated_conjecture,
    ( ~ subclass(image(xr,y),image(xr,z)) )).
