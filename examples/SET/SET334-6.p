%--------------------------------------------------------------------------
% File     : SET334-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of image 2
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_image2_1,negated_conjecture,
    ( subclass(xr,yr) )).

cnf(prove_monotonicity_of_image2_2,negated_conjecture,
    ( ~ subclass(image(xr,z),image(yr,z)) )).
