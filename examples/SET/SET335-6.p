%--------------------------------------------------------------------------
% File     : SET335-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image property 1
...
%--------------------------------------------------------------------------
cnf(prove_image_property1_1,negated_conjecture,
    ( intersection(x,domain_of(z)) = null_class )).

cnf(prove_image_property1_2,negated_conjecture,
    (  image(z,x) != null_class )).
