%--------------------------------------------------------------------------
% File     : SET338-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 3 image property 1
...
%--------------------------------------------------------------------------
cnf(prove_corollary_3_image_property1_1,negated_conjecture,
    ( ~ member(x,domain_of(z)) )).

cnf(prove_corollary_3_image_property1_2,negated_conjecture,
    (  image(z,singleton(x)) != null_class )).
