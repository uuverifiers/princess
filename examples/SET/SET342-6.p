%--------------------------------------------------------------------------
% File     : SET342-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image of union
...
%--------------------------------------------------------------------------
cnf(prove_image_of_union_1,negated_conjecture,
    ( ~ subclass(image(xr,union(y,z)),union(image(xr,y),image(xr,z))) )).
