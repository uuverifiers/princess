%--------------------------------------------------------------------------
% File     : SET343-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Image of intersection
...
%--------------------------------------------------------------------------
cnf(prove_image_of_intersection_1,negated_conjecture,
    (  image(xr,intersection(y,z)) != intersection(image(xr,y),image(xr,z)) )).
