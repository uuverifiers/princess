%--------------------------------------------------------------------------
% File     : SET349-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum class of singleton null is null class 1
...
%--------------------------------------------------------------------------
cnf(prove_sum_class_of_singleton_null_1,negated_conjecture,
    (  sum_class(singleton(null_class)) != null_class )).
