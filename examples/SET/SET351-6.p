%--------------------------------------------------------------------------
% File     : SET351-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum class of a singleton is the singleton member
...
%--------------------------------------------------------------------------
cnf(prove_sum_of_singleton_1,negated_conjecture,
    ( member(x,universal_class) )).

cnf(prove_sum_of_singleton_2,negated_conjecture,
    (  sum_class(singleton(x)) != x )).
