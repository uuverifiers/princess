%--------------------------------------------------------------------------
% File     : SET352-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : The sum class of an unordered pair is the union of the pair
...
%--------------------------------------------------------------------------
cnf(prove_sum_of_pair_1,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_sum_of_pair_2,negated_conjecture,
    (  sum_class(unordered_pair(x,y)) != union(x,y) )).
