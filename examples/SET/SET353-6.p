%--------------------------------------------------------------------------
% File     : SET353-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_sum_of_pair_1,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_corollary_to_sum_of_pair_2,negated_conjecture,
    ( ~ member(union(x,y),universal_class) )).
