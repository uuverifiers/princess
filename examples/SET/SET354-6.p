%--------------------------------------------------------------------------
% File     : SET354-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum of ordered pair
...
%--------------------------------------------------------------------------
cnf(prove_sum_of_ordered_pair_1,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_sum_of_ordered_pair_2,negated_conjecture,
    (  sum_class(ordered_pair(x,y)) != unordered_pair(x,singleton(y)) )).
