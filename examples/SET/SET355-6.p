%--------------------------------------------------------------------------
% File     : SET355-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : If X is in Y, then X is a subset of the sum class of Y
...
%--------------------------------------------------------------------------
cnf(prove_subclass_of_union_1,negated_conjecture,
    ( member(x,y) )).

cnf(prove_subclass_of_union_2,negated_conjecture,
    ( ~ subclass(x,sum_class(y)) )).
