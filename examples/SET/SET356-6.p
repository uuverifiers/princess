%--------------------------------------------------------------------------
% File     : SET356-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary to subclass of union
...
%--------------------------------------------------------------------------
cnf(prove_corollary_to_subclass_of_union_1,negated_conjecture,
    ( ~ subclass(y,power_class(sum_class(y))) )).
