%--------------------------------------------------------------------------
% File     : SET357-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum class alternate definition 4
...
%--------------------------------------------------------------------------
cnf(prove_sum_class_alternate_defn4_1,negated_conjecture,
    (  image(inverse(element_relation),x) != sum_class(x) )).
