%--------------------------------------------------------------------------
% File     : SET358-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum class distributes over union
...
%--------------------------------------------------------------------------
cnf(prove_sum_over_union_1,negated_conjecture,
    (  sum_class(union(x,y)) != union(sum_class(x),sum_class(y)) )).
