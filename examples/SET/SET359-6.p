%--------------------------------------------------------------------------
% File     : SET359-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum class property 1
...
%--------------------------------------------------------------------------
cnf(prove_sum_class_property1_1,negated_conjecture,
    ( ~ subclass(sum_class(intersection(x,y)),intersection(sum_class(x),sum_class(y))) )).
