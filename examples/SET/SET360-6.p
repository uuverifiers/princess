%--------------------------------------------------------------------------
% File     : SET360-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain is sum squared
...
%--------------------------------------------------------------------------
cnf(prove_domain_is_sum_squared_1,negated_conjecture,
    ( ~ subclass(domain_of(x),sum_class(sum_class(x))) )).
