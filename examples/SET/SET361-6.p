%--------------------------------------------------------------------------
% File     : SET361-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Range is sum squared
...
%          : v2.1.0 - Fixed prove_range_is_sum_squared_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_range_is_sum_squared_1,negated_conjecture,
    ( ~ subclass(range_of(x),sum_class(sum_class(sum_class(x)))) )).
