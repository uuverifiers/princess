%--------------------------------------------------------------------------
% File     : SET363-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Power class alternative definition 1
...
%--------------------------------------------------------------------------
cnf(prove_power_class_alternative_defn1_1,negated_conjecture,
    ( member(z,power_class(x)) )).

cnf(prove_power_class_alternative_defn1_2,negated_conjecture,
    ( ~ subclass(z,x) )).
