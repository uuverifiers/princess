%--------------------------------------------------------------------------
% File     : SET365-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of power
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_power_1,negated_conjecture,
    ( subclass(x,y) )).

cnf(prove_monotonicity_of_power_2,negated_conjecture,
    ( ~ subclass(power_class(x),power_class(y)) )).
