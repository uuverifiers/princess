%--------------------------------------------------------------------------
% File     : SET367-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Power class not in null class
...
%--------------------------------------------------------------------------
cnf(prove_power_class_not_null_class_1,negated_conjecture,
    ( power_class(x) = null_class )).
