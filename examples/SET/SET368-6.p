%--------------------------------------------------------------------------
% File     : SET368-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Power class of universal class is universal class
...
% Rating   : 1.00 v5.4.0, 0.95 v5.3.0, 1.00 v2.1.0
...
%--------------------------------------------------------------------------
cnf(prove_power_class_of_universal_class_1,negated_conjecture,
    (  power_class(universal_class) != universal_class )).
