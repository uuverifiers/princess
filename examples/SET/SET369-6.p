%--------------------------------------------------------------------------
% File     : SET369-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Power class of set
...
%--------------------------------------------------------------------------
cnf(prove_power_class_of_set_1,negated_conjecture,
    ( member(x,universal_class) )).

cnf(prove_power_class_of_set_2,negated_conjecture,
    (  image(inverse(subset_relation),singleton(x)) != power_class(x) )).
