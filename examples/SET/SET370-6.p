%--------------------------------------------------------------------------
% File     : SET370-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Power class property 1
...
%          : v2.1.0 - Fixed prove_power_class_property1_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_power_class_property1_1,negated_conjecture,
    ( ~ subclass(cross_product(x,y),power_class(power_class(union(x,power_class(y))))) )).
