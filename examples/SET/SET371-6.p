%--------------------------------------------------------------------------
% File     : SET371-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Power class property 2
...
%          : v1.2.1 - Fixed prove_power_class_property2_1.
...
%--------------------------------------------------------------------------
cnf(prove_power_class_property2_1,negated_conjecture,
    ( ~ subclass(x,sum_class(power_class(x))) )).
