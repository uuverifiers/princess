%--------------------------------------------------------------------------
% File     : SET372-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v1.2.1 - Fixed prove_power_class_property3_1.
...
%--------------------------------------------------------------------------
cnf(prove_power_class_property3_1,negated_conjecture,
    (  intersection(power_class(x),power_class(y)) != power_class(intersection(x,y)) )).
