%--------------------------------------------------------------------------
% File     : SET377-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to power class set builder
...
cnf(prove_corollary_1_to_power_class_set_builder_1,negated_conjecture,
    ( member(x,intersection(power_class(z),z)) )).

cnf(prove_corollary_1_to_power_class_set_builder_2,negated_conjecture,
    ( ~ member(successor(x),power_class(z)) )).
