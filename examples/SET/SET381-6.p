%--------------------------------------------------------------------------
% File     : SET381-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Relation property 2
...
%--------------------------------------------------------------------------
cnf(prove_relation_property2_1,negated_conjecture,
    ( subclass(x,cross_product(universal_class,universal_class)) )).

cnf(prove_relation_property2_2,negated_conjecture,
    ( ~ subclass(x,cross_product(domain_of(x),range_of(x))) )).
