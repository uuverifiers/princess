%--------------------------------------------------------------------------
% File     : SET382-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to relation property 2
...
% Source   : [Quaife]
% Names    : RL2 cor.2 [Qua92]

% Status   : Unsatisfiable
% Rating   : 0.80 v6.1.0, 0.86 v6.0.0, 0.70 v5.5.0, 0.85 v5.3.0, 0.89 v5.2.0, 0.88 v5.0.0, 0.86 v4.1.0, 0.85 v4.0.1, 0.82 v4.0.0, 0.73 v3.7.0, 0.60 v3.5.0, 0.64 v3.4.0, 0.75 v3.3.0, 0.71 v3.2.0, 0.69 v3.1.0, 0.73 v2.7.0, 0.75 v2.6.0, 0.78 v2.5.0, 0.64 v2.4.0, 0.75 v2.3.0, 1.00 v2.1.0
