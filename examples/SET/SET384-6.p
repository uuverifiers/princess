%--------------------------------------------------------------------------
% File     : SET384-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to relation property 3
...
%--------------------------------------------------------------------------
cnf(prove_relation_property3_1,negated_conjecture,
