%--------------------------------------------------------------------------
% File     : SET392-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Right identity for composition
...
%          : v2.1.0 - Fixed prove_right_identity_for_composition_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_right_identity_for_composition_1,negated_conjecture,
    (  compose(x,identity_relation) != restrict(x,universal_class,universal_class) )).
