%--------------------------------------------------------------------------
% File     : SET393-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Left identity for composition
...
%          : v2.1.0 - Fixed prove_left_identity_for_composition_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_left_identity_for_composition_1,negated_conjecture,
    (  compose(identity_relation,x) != restrict(x,universal_class,universal_class) )).
