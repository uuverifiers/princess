%--------------------------------------------------------------------------
% File     : SET394-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_composition_property2_1,negated_conjecture,
    ( ~ subclass(restrict(identity_relation,domain_of(x),universal_class),compose(inverse(x),x)) )).
