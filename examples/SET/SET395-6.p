%--------------------------------------------------------------------------
% File     : SET395-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Composition relates to image
...
%--------------------------------------------------------------------------
cnf(prove_compositions_relates_to_image_1,negated_conjecture,
    (  image(compose(xr,yr),x) != image(xr,image(yr,x)) )).
