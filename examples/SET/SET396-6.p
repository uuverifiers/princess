%--------------------------------------------------------------------------
% File     : SET396-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Domain of composition 1
...
%--------------------------------------------------------------------------
cnf(prove_domain_of_composition_1,negated_conjecture,
    ( ~ subclass(domain_of(compose(xr,yr)),domain_of(yr)) )).
