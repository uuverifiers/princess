%--------------------------------------------------------------------------
% File     : SET400-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Right compose with null class
...
%--------------------------------------------------------------------------
cnf(prove_right_compose_with_null_class_1,negated_conjecture,
    (  compose(x,null_class) != null_class )).
