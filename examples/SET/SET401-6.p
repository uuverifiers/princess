%--------------------------------------------------------------------------
% File     : SET401-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Left compose with universal class
...
%          : v2.1.0 - Fixed prove_left_compose_with_universal_class_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_left_compose_with_universal_class_1,negated_conjecture,
    (  compose(universal_class,x) != cross_product(domain_of(x),universal_class) )).
