%--------------------------------------------------------------------------
% File     : SET402-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Right compose with universal class
...
%          : v2.1.0 - Fixed prove_right_compose_with_universal_class_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_right_compose_with_universal_class_1,negated_conjecture,
    (  compose(x,universal_class) != cross_product(universal_class,range_of(x)) )).
