%--------------------------------------------------------------------------
% File     : SET404-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of composition 1
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_composition1_1,negated_conjecture,
    ( subclass(xr,yr) )).

cnf(prove_monotonicity_of_composition1_2,negated_conjecture,
    ( ~ subclass(compose(zr,xr),compose(zr,yr)) )).
