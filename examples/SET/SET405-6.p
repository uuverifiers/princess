%--------------------------------------------------------------------------
% File     : SET405-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Monotonicity of composition 2
...
%--------------------------------------------------------------------------
cnf(prove_monotonicity_of_composition2_1,negated_conjecture,
    ( subclass(xr,yr) )).

cnf(prove_monotonicity_of_composition2_2,negated_conjecture,
    ( ~ subclass(compose(xr,zr),compose(yr,zr)) )).
