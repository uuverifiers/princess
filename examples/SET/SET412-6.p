%--------------------------------------------------------------------------
% File     : SET412-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Compose condition for singleton membership 2
...
%--------------------------------------------------------------------------
cnf(prove_compose_condition_for_singleton_membership2_1,negated_conjecture,
    ( member(ordered_pair(x,y),singleton_relation) )).

cnf(prove_compose_condition_for_singleton_membership2_2,negated_conjecture,
    (  singleton(x) != y )).
