%--------------------------------------------------------------------------
% File     : SET419-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Composition property 3
...
%--------------------------------------------------------------------------
cnf(prove_composition_property3_1,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_composition_property3_2,negated_conjecture,
    (  apply(image(composition_function,singleton(x)),y) != compose(x,y) )).
