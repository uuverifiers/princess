%--------------------------------------------------------------------------
% File     : SET421-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Compose class is a function
...
%--------------------------------------------------------------------------
cnf(prove_compose_class_is_a_function_1,negated_conjecture,
    ( ~ function(compose_class(x)) )).
