%--------------------------------------------------------------------------
% File     : SET423-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Sum compose class
...
%--------------------------------------------------------------------------
cnf(prove_sum_compose_class_1,negated_conjecture,
    (  sum_class(image(compose_class(x),y)) != compose(x,sum_class(y)) )).
