%--------------------------------------------------------------------------
% File     : SET428-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_single_valued_class_alternate_defn4_1,negated_conjecture,
    ( single_valued1(x) = single_valued2(x) )).

cnf(prove_single_valued_class_alternate_defn4_2,negated_conjecture,
