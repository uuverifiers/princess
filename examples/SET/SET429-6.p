%--------------------------------------------------------------------------
% File     : SET429-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : A subclass of a single-valued class is single-valued
...
%--------------------------------------------------------------------------
cnf(prove_single_valued_subclass_1,negated_conjecture,
    ( single_valued_class(x) )).

cnf(prove_single_valued_subclass_2,negated_conjecture,
    ( ~ single_valued_class(intersection(x,y)) )).
