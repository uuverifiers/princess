%--------------------------------------------------------------------------
% File     : SET431-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_compose_single_valued_classes_1,negated_conjecture,
    ( single_valued_class(xr) )).

cnf(prove_compose_single_valued_classes_2,negated_conjecture,
    ( single_valued_class(yr) )).

cnf(prove_compose_single_valued_classes_3,negated_conjecture,
    ( ~ single_valued_class(compose(xr,yr)) )).
