%--------------------------------------------------------------------------
% File     : SET432-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_function_alternate_defn1_1,negated_conjecture,
    ( function(z) )).

cnf(prove_function_alternate_defn1_2,negated_conjecture,
    ( member(ordered_pair(u,v),z) )).

cnf(prove_function_alternate_defn1_3,negated_conjecture,
    ( member(ordered_pair(u,w),z) )).

cnf(prove_function_alternate_defn1_4,negated_conjecture,
    (  v != w )).
