%--------------------------------------------------------------------------
% File     : SET434-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_function_alternate_defn3_1,negated_conjecture,
    ( subclass(x,cross_product(universal_class,universal_class)) )).

cnf(prove_function_alternate_defn3_2,negated_conjecture,
    ( ~ member(ordered_pair(single_valued3(x),single_valued2(x)),x) )).

cnf(prove_function_alternate_defn3_3,negated_conjecture,
    ( ~ function(x) )).
