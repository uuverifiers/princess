%--------------------------------------------------------------------------
% File     : SET435-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_function_alternate_defn4_1,negated_conjecture,
    ( subclass(x,cross_product(universal_class,universal_class)) )).

cnf(prove_function_alternate_defn4_2,negated_conjecture,
    ( single_valued1(x) = single_valued2(x) )).

cnf(prove_function_alternate_defn4_3,negated_conjecture,
    ( ~ function(x) )).
