%--------------------------------------------------------------------------
% File     : SET446-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_function_property2_1,negated_conjecture,
    ( member(y,universal_class) )).

cnf(prove_function_property2_2,negated_conjecture,
    ( ~ function(cross_product(x,singleton(y))) )).
