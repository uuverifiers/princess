%--------------------------------------------------------------------------
% File     : SET455-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_identity_alternate_defn2_1,negated_conjecture,
    ( member(ordered_pair(x,y),identity_relation) )).

cnf(prove_identity_alternate_defn2_2,negated_conjecture,
    (  x != y )).
