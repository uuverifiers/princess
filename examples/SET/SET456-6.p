%--------------------------------------------------------------------------
% File     : SET456-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%            naming scheme).
%          : This version from [Quaife] is slightly more general than that
%            in [Qua92].
...
%--------------------------------------------------------------------------
cnf(prove_identity_alternate_defn3_1,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_identity_alternate_defn3_2,negated_conjecture,
    ( x = y )).

cnf(prove_identity_alternate_defn3_3,negated_conjecture,
