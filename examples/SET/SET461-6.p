%--------------------------------------------------------------------------
% File     : SET461-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_domain_of_restricted_identity_1,negated_conjecture,
    (  domain_of(restrict(identity_relation,x,y)) != intersection(x,y) )).
