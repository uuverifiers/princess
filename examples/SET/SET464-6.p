%--------------------------------------------------------------------------
% File     : SET464-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_class_image_under_identity_1,negated_conjecture,
    (  image(restrict(identity_relation,x,x),y) != intersection(x,y) )).
