%--------------------------------------------------------------------------
% File     : SET472-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v1.2.1 - Fixed prove_sets_with_many_members2_2.
%          : v2.1.0 - Fixed prove_sets_with_many_members2_2 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_sets_with_many_members2_1,negated_conjecture,
    ( member(u,x) )).

cnf(prove_sets_with_many_members2_2,negated_conjecture,
    ( not_subclass_element(intersection(x,complement(singleton(u))),null_class) = u )).

cnf(prove_sets_with_many_members2_3,negated_conjecture,
