%--------------------------------------------------------------------------
% File     : SET476-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_intersection_subclass_1,negated_conjecture,
    ( ~ subclass(intersection(x,identity_relation),intersection(x,inverse(x))) )).
