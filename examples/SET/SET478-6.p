%--------------------------------------------------------------------------
% File     : SET478-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_axiom_of_subsets2_1,negated_conjecture,
    ( member(y,universal_class) )).

cnf(prove_axiom_of_subsets2_2,negated_conjecture,
    ( ~ member(intersection(x,y),universal_class) )).
