%--------------------------------------------------------------------------
% File     : SET480-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Replacement property 2
...
%--------------------------------------------------------------------------
cnf(prove_replacement_property2_1,negated_conjecture,
    ( member(x,universal_class) )).

cnf(prove_replacement_property2_2,negated_conjecture,
    ( ~ member(range_of(x),universal_class) )).
