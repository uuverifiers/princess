%--------------------------------------------------------------------------
% File     : SET482-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_replacement_property4_1,negated_conjecture,
    ( member(ordered_pair(domain_of(x),range_of(x)),cross_product(universal_class,universal_class)) )).

cnf(prove_replacement_property4_2,negated_conjecture,
    ( subclass(x,cross_product(universal_class,universal_class)) )).

cnf(prove_replacement_property4_3,negated_conjecture,
