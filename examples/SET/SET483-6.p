%--------------------------------------------------------------------------
% File     : SET483-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_replacement_property5_1,negated_conjecture,
    ( member(x,universal_class) )).

cnf(prove_replacement_property5_2,negated_conjecture,
    ( ~ member(inverse(x),universal_class) )).
