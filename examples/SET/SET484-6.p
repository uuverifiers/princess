%--------------------------------------------------------------------------
% File     : SET484-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_replacement_property6_1,negated_conjecture,
    ( function(xf) )).

cnf(prove_replacement_property6_2,negated_conjecture,
    ( member(domain_of(xf),universal_class) )).

cnf(prove_replacement_property6_3,negated_conjecture,
    ( ~ member(xf,universal_class) )).
