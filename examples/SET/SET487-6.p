%--------------------------------------------------------------------------
% File     : SET487-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Replacement property 9
...
%--------------------------------------------------------------------------
cnf(prove_replacement_property9_1,negated_conjecture,
    ( member(power_class(x),universal_class) )).

cnf(prove_replacement_property9_2,negated_conjecture,
