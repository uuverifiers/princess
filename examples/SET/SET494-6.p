%--------------------------------------------------------------------------
% File     : SET494-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v2.1.0 - Fixed prove_diagonalization_alternate_defn1_1 [Bel97].
...
%--------------------------------------------------------------------------
cnf(prove_diagonalization_alternate_defn1_1,negated_conjecture,
    (  domain_of(intersection(complement(x),identity_relation)) != diagonalise(x) )).
