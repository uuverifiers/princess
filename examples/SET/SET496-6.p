%--------------------------------------------------------------------------
% File     : SET496-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_diagonalization_alternate_defn3_1,negated_conjecture,
    ( member(z,universal_class) )).

cnf(prove_diagonalization_alternate_defn3_2,negated_conjecture,
    ( ~ member(z,diagonalise(xr)) )).

cnf(prove_diagonalization_alternate_defn3_3,negated_conjecture,
    ( ~ member(ordered_pair(z,z),xr) )).
