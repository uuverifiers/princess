%--------------------------------------------------------------------------
% File     : SET498-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_russell_class2_1,negated_conjecture,
    ( member(z,universal_class) )).

cnf(prove_russell_class2_2,negated_conjecture,
    ( ~ member(z,diagonalise(element_relation)) )).

cnf(prove_russell_class2_3,negated_conjecture,
    ( ~ member(z,z) )).
