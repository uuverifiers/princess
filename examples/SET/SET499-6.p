%--------------------------------------------------------------------------
% File     : SET499-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : The Russell class not a set
...
%--------------------------------------------------------------------------
cnf(prove_russell_class_not_a_set_1,negated_conjecture,
    ( member(diagonalise(element_relation),universal_class) )).
