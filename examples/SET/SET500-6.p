%--------------------------------------------------------------------------
% File     : SET500-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_diagonalization_property1_1,negated_conjecture,
    (  complement(range_of(intersection(xr,identity_relation))) != diagonalise(xr) )).
