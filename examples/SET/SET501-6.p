%--------------------------------------------------------------------------
% File     : SET501-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_diagonalization_property2_1,negated_conjecture,
    (  diagonalise(compose(inverse(xr),xs)) != complement(domain_of(intersection(xr,xs))) )).
