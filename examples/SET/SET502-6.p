%--------------------------------------------------------------------------
% File     : SET502-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_diagonalization_property3_1,negated_conjecture,
    (  diagonalise(compose(xr,inverse(xs))) != complement(range_of(intersection(xr,xs))) )).
