%--------------------------------------------------------------------------
% File     : SET512-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 2 to special members of ordered pairs
...
%--------------------------------------------------------------------------
cnf(prove_corollary_2_to_property_1_of_ordered_pair_1,negated_conjecture,
    (  unordered_pair(null_class,singleton(singleton(y))) != ordered_pair(universal_class,y) )).
