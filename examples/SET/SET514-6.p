%--------------------------------------------------------------------------
% File     : SET514-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Class of ordered pairs is not a set
...
%--------------------------------------------------------------------------
cnf(prove_class_of_ordered_pairs_not_set_1,negated_conjecture,
    ( member(cross_product(universal_class,universal_class),x) )).
