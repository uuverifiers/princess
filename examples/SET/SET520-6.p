%--------------------------------------------------------------------------
% File     : SET520-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 2 to no cycles of length 2
...
%            naming scheme).
%          : This is not an immediate corollary of RE4. Need to add the
%            theorem that the axiom of regularity implies that there are
...
%--------------------------------------------------------------------------
cnf(prove_corollary_2_no_cycles_length_2_1,negated_conjecture,
    ( ordered_pair(x,y) = y )).
