%--------------------------------------------------------------------------
% File     : SET525-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_condition_for_x_not_to_be_an_ordered_pair2_1,negated_conjecture,
    ( second(x) = x )).

cnf(prove_condition_for_x_not_to_be_an_ordered_pair2_2,negated_conjecture,
    (  first(x) != x )).
