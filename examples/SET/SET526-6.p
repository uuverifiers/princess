%--------------------------------------------------------------------------
% File     : SET526-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Ordered pair components are sets 1
...
%--------------------------------------------------------------------------
cnf(prove_ordered_pair_components_are_sets1_1,negated_conjecture,
    ( ordered_pair(first(x),second(x)) = x )).

cnf(prove_ordered_pair_components_are_sets1_2,negated_conjecture,
