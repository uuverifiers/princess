%--------------------------------------------------------------------------
% File     : SET527-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_ordered_pair_components_are_sets2_1,negated_conjecture,
    ( ordered_pair(first(x),second(x)) = x )).

cnf(prove_ordered_pair_components_are_sets2_2,negated_conjecture,
    ( ~ member(second(x),universal_class) )).
