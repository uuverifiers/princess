%--------------------------------------------------------------------------
% File     : SET532-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v1.2.1 - Fixed prove_application_property2_1.
...
%--------------------------------------------------------------------------
cnf(prove_application_property2_1,negated_conjecture,
    ( single_valued_class(z) )).

cnf(prove_application_property2_2,negated_conjecture,
    ( member(x,domain_of(z)) )).

cnf(prove_application_property2_3,negated_conjecture,
    (  image(z,singleton(x)) != singleton(apply(z,x)) )).
