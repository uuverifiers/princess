%--------------------------------------------------------------------------
% File     : SET534-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%          : v1.2.1 - Fixed prove_class_of_applications_to_domain2_1.
...
%--------------------------------------------------------------------------
cnf(prove_class_of_applications_to_domain2_1,negated_conjecture,
    ( single_valued_class(z) )).

cnf(prove_class_of_applications_to_domain2_2,negated_conjecture,
    ( member(y,range_of(z)) )).

cnf(prove_class_of_applications_to_domain2_3,negated_conjecture,
    (  apply(z,domain(z,universal_class,y)) != y )).
