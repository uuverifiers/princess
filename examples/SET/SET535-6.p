%--------------------------------------------------------------------------
% File     : SET535-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_application_property3_1,negated_conjecture,
    ( member(y,image(xf,singleton(x))) )).

cnf(prove_application_property3_2,negated_conjecture,
