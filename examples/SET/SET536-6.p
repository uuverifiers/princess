%--------------------------------------------------------------------------
% File     : SET536-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 1 to application property 3
...
%--------------------------------------------------------------------------
cnf(prove_corollary_1_to_application_property3_1,negated_conjecture,
    ( ~ subclass(image(xf,singleton(x)),power_class(apply(xf,x))) )).
