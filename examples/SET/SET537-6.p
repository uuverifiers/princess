%--------------------------------------------------------------------------
% File     : SET537-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Corollary 2 to application property 3
...
%--------------------------------------------------------------------------
cnf(prove_corollary_2_to_application_property3_1,negated_conjecture,
    ( member(ordered_pair(x,y),xf) )).

cnf(prove_corollary_2_to_application_property3_2,negated_conjecture,
    ( member(ordered_pair(x,y),cross_product(universal_class,universal_class)) )).

cnf(prove_corollary_2_to_application_property3_3,negated_conjecture,
    ( ~ subclass(y,apply(xf,x)) )).
