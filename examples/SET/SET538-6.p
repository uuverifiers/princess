%--------------------------------------------------------------------------
% File     : SET538-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Application property 4
...
%            naming scheme).
%          : This [Quaife] version is different from that in [Qua92].
...
%--------------------------------------------------------------------------
cnf(prove_application_property4_1,negated_conjecture,
    (  image(sum_class(xf),image(xf,singleton(x))) != apply(xf,x) )).
