%--------------------------------------------------------------------------
% File     : SET539-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Application property 5
...
%--------------------------------------------------------------------------
cnf(prove_application_property5_1,negated_conjecture,
    ( member(z,apply(xf,z)) )).

cnf(prove_application_property5_2,negated_conjecture,
