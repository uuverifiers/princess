%--------------------------------------------------------------------------
% File     : SET541-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_application_property7_1,negated_conjecture,
    (  apply(z,x) != null_class )).

cnf(prove_application_property7_2,negated_conjecture,
