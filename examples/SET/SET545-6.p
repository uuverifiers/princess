%--------------------------------------------------------------------------
% File     : SET545-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_application_special_case1_1,negated_conjecture,
    ( member(x,universal_class) )).

cnf(prove_application_special_case1_2,negated_conjecture,
    (  apply(universal_class,x) != universal_class )).
