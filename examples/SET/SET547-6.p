%--------------------------------------------------------------------------
% File     : SET547-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Application special case 3
...
%--------------------------------------------------------------------------
cnf(prove_application_special_case3_1,negated_conjecture,
    (  apply(x,universal_class) != null_class )).
