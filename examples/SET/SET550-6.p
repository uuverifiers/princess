%--------------------------------------------------------------------------
% File     : SET550-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Application property 18
...
%--------------------------------------------------------------------------
cnf(prove_application_property15_1,negated_conjecture,
    ( ~ function(image(application_function,singleton(x))) )).
