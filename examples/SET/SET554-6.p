%--------------------------------------------------------------------------
% File     : SET554-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
% Problem  : Cantor class alternate definition 2
...
%--------------------------------------------------------------------------
cnf(prove_cantor_class_property1_1,negated_conjecture,
    ( member(z,cantor(xr)) )).

cnf(prove_cantor_class_property1_2,negated_conjecture,
    ( member(z,apply(xr,z)) )).
