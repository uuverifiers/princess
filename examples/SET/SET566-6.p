%--------------------------------------------------------------------------
% File     : SET566-6 : TPTP v6.1.0. Bugfixed v2.1.0.
% Domain   : Set Theory
...
%--------------------------------------------------------------------------
cnf(prove_compatible_function_property4_1,negated_conjecture,
    ( compatible(xh1,xf1,xf2) )).

cnf(prove_compatible_function_property4_2,negated_conjecture,
    ( compatible(xh2,xf2,xf3) )).

cnf(prove_compatible_function_property4_3,negated_conjecture,
    ( ~ compatible(compose(xh2,xh1),xf1,xf3) )).
