%------------------------------------------------------------------------------
% File     : SET585^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-38
% Version  : Especial.
% English  : Trybulec's 38th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0097 [Bro09]
%          : BOOL-PROP-38 [TPS]
...
%            Number of connectives :    7 (   0   ~;   1   |;   1   &;   4   @)
%                                         (   0 <=>;   1  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_38_pme,conjecture,(
    ! [X: a > $o,Y: a > $o,Z: a > $o,Xx: a] :
      ( ( ( X @ Xx )
        & ( Y @ Xx ) )
     => ( ( X @ Xx )
        | ( Z @ Xx ) ) ) )).
