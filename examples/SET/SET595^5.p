%------------------------------------------------------------------------------
% File     : SET595^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-54
% Version  : Especial.
% English  : Trybulec's 54th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0219 [Bro09]
%          : BOOL-PROP-54 [TPS]
...
%            Number of atoms       :   13 (   1 equality;  11 variable)
%            Maximal formula depth :   10 (   6 average)
%            Number of connectives :   10 (   1   ~;   1   |;   1   &;   5   @)
%                                         (   0 <=>;   2  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_54_pme,conjecture,(
    ! [X: a > $o,Y: a > $o] :
      ( ! [Xx: a] :
          ( ( X @ Xx )
         => ( Y @ Xx ) )
