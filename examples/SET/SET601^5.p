%------------------------------------------------------------------------------
% File     : SET601^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-72
% Version  : Especial.
% English  : Trybulec's 72nd Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0433 [Bro09]
%          : BOOL-PROP-72 [TPS]
...
%            Number of atoms       :   26 (   1 equality;  24 variable)
%            Maximal formula depth :   10 (   6 average)
%            Number of connectives :   22 (   0   ~;   5   |;   5   &;  12   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
