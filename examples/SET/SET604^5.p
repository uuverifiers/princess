%------------------------------------------------------------------------------
% File     : SET604^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-75
% Version  : Especial.
% English  : Trybulec's 75th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0177 [Bro09]
%          : BOOL-PROP-75 [TPS]
...
%            Number of atoms       :    6 (   1 equality;   2 variable)
...
thf(cBOOL_PROP_75_pme,conjecture,(
    ! [X: a > $o] :
      ( ( ^ [Xx: a] :
            ( $false
            & ~ ( X @ Xx ) ) )
