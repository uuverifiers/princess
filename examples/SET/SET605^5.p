%------------------------------------------------------------------------------
% File     : SET605^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-76
% Version  : Especial.
% English  : Trybulec's 76th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0192 [Bro09]
%          : BOOL-PROP-76 [TPS]
...
%            Number of atoms       :    9 (   1 equality;   6 variable)
%            Maximal formula depth :    9 (   6 average)
%            Number of connectives :    6 (   1   ~;   1   |;   1   &;   3   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
