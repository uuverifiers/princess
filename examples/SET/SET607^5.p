%------------------------------------------------------------------------------
% File     : SET607^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-79
% Version  : Especial.
% English  : Trybulec's 79th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0206 [Bro09]
%          : BOOL-PROP-79 [TPS]
...
%            Number of connectives :    9 (   1   ~;   2   |;   1   &;   5   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_79_pme,conjecture,(
    ! [X: a > $o,Y: a > $o] :
      ( ( ^ [Xz: a] :
            ( ( X @ Xz )
            | ( ( Y @ Xz )
