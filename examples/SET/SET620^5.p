%------------------------------------------------------------------------------
% File     : SET620^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-96
% Version  : Especial.
% English  : Trybulec's 96th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0354 [Bro09]
%          : BOOL-PROP-96 [TPS]
...
%            Number of atoms       :   18 (   1 equality;  16 variable)
%            Maximal formula depth :    9 (   6 average)
%            Number of connectives :   17 (   3   ~;   2   |;   4   &;   8   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
...
thf(cBOOL_PROP_96_pme,conjecture,(
    ! [X: a > $o,Y: a > $o] :
      ( ( ^ [Xz: a] :
            ( ( ( X @ Xz )
              & ~ ( Y @ Xz ) )
