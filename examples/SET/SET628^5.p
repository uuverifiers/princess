%------------------------------------------------------------------------------
% File     : SET628^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-110
% Version  : Especial.
% English  : Trybulec's 110th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0376 [Bro09]
%          : BOOL-PROP-110 [TPS]
...
%            Number of atoms       :    8 (   1 equality;   5 variable)
...
%            Number of variables   :    3 (   1 sgn;   1   !;   1   ?;   1   ^)
%                                         (   3   :;   0  !>;   0  ?*)
%                                         (   0  @-;   0  @+)
% SPC      : TH0_THM_EQU
...
thf(cBOOL_PROP_110_pme,conjecture,(
    ! [X: a > $o] :
      ( ? [Xx: a] :
          ( ( X @ Xx )
          & ( X @ Xx ) )
