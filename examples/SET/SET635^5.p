%------------------------------------------------------------------------------
% File     : SET635^5 : TPTP v6.1.0. Released v4.0.0.
% Domain   : Set Theory
% Problem  : TPS problem BOOL-PROP-117
% Version  : Especial.
% English  : Trybulec's 117th Boolean property of sets

% Refs     : [TS89]  Trybulec & Swieczkowska (1989), Boolean Properties of
%          : [Bro09] Brown (2009), Email to Geoff Sutcliffe
% Source   : [Bro09]
% Names    : tps_0414 [Bro09]
%          : BOOL-PROP-117 [TPS]
...
%            Number of connectives :   14 (   2   ~;   0   |;   5   &;   7   @)
%                                         (   0 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&;   0  !!;   0  ??)
