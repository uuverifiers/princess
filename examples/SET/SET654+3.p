%--------------------------------------------------------------------------
% File     : SET654+3 : TPTP v6.1.0. Released v2.2.0.
% Domain   : Set Theory (Relations)
% Problem  : Y a subset of Y1 => R (X to Y) is (X to Y1)
% Version  : [Wor90] axioms : Reduced > Incomplete.
% English  : If Y is a subset of Y1 then a relation R from X to Y is a
%            relation from X to Y1.

% Refs     : [ILF] The ILF Group (1998), The ILF System: A Tool for the Int
%          : [Wor90] Woronowicz (1990), Relations Defined on Sets
% Source   : [ILF]
% Names    : RELSET_1 (16) [Wor90]

% Status   : Theorem
% Rating   : 0.24 v6.1.0, 0.20 v6.0.0, 0.22 v5.5.0, 0.19 v5.4.0, 0.18 v5.3.0, 0.26 v5.2.0, 0.15 v5.1.0, 0.14 v5.0.0, 0.21 v4.1.0, 0.26 v4.0.0, 0.25 v3.7.0, 0.20 v3.5.0, 0.21 v3.3.0, 0.14 v3.2.0, 0.18 v3.1.0, 0.11 v2.7.0, 0.17 v2.6.0, 0.14 v2.5.0, 0.12 v2.4.0, 0.25 v2.3.0, 0.33 v2.2.1
...
%---- type_nonempty(line(hidden - axiom123,1832648))
fof(p11,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
...
%---- declaration(line(hidden - axiom125,1832644))
fof(p14,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ( ~ empty(power_set(B))
...
%---- type_nonempty(line(hidden - axiom126,1832640))
fof(p16,axiom,
    ( ! [B] :
        ( ( ~ empty(B)
          & ilf_type(B,set_type) )
...
%---- conditional_cluster(axiom129,relation_like)
fof(p19,axiom,
    ( ! [B] :
        ( ( empty(B)
          & ilf_type(B,set_type) )
...
%---- conditional_cluster(axiom130,relation_like)
fof(p20,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- line(relset_1 - th(16),1916267)
fof(prove_relset_1_16,conjecture,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
            ( ilf_type(C,set_type)
