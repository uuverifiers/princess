%------------------------------------------------------------------------------
% File     : SET672^3 : TPTP v6.1.0. Released v3.6.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.00 v6.0.0, 0.14 v5.5.0, 0.17 v5.4.0, 0.20 v5.3.0, 0.40 v5.2.0, 0.20 v4.1.0, 0.33 v3.7.0
...
thf(thm,conjecture,(
    ! [Z: $i > $o,R: $i > $i > $o,X: $i > $o,Y: $i > $o] :
      ( ( is_rel_on @ R @ X @ Y )
     => ( is_rel_on @ ( restrict_rel_codomain @ R @ Z ) @ X @ Z ) ) )).
