%------------------------------------------------------------------------------
% File     : SET683+3 : TPTP v6.1.0. Released v2.2.0.
% Domain   : Set Theory (Relations)
% Problem  : !y in E : y in range of R (X to Y) ?x in D : x in domain of R
% Version  : [Wor90] axioms : Reduced > Incomplete.
% English  : For every element y in E such that y is in the range in a relation
%            R from X to Y there exists an element x in D such that x is in the
%            domain of R.

% Refs     : [ILF] The ILF Group (1998), The ILF System: A Tool for the Int
%          : [Wor90] Woronowicz (1990), Relations Defined on Sets
% Source   : [ILF]
% Names    : RELSET_1 (50) [Wor90]

% Status   : Theorem
% Rating   : 0.40 v6.1.0, 0.37 v6.0.0, 0.35 v5.5.0, 0.30 v5.4.0, 0.32 v5.3.0, 0.37 v5.2.0, 0.20 v5.1.0, 0.19 v5.0.0, 0.33 v4.1.0, 0.35 v4.0.0, 0.33 v3.7.0, 0.30 v3.5.0, 0.26 v3.4.0, 0.32 v3.3.0, 0.21 v3.2.0, 0.18 v3.1.0, 0.22 v2.7.0, 0.50 v2.6.0, 0.29 v2.5.0, 0.25 v2.4.0, 0.25 v2.3.0, 0.33 v2.2.1
...
%---- type_nonempty(line(hidden - axiom650,1832640))
fof(p5,axiom,
    ( ! [B] :
        ( ( ~ empty(B)
          & ilf_type(B,set_type) )
...
%---- type_nonempty(line(relat_1 - axiom653,1917641))
fof(p11,axiom,
    ( ? [B] : ilf_type(B,binary_relation_type) )).

%---- line(hidden - axiom654,1832648)
fof(p12,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- type_nonempty(line(hidden - axiom654,1832648))
fof(p13,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ? [C] : ilf_type(C,subset_type(B)) ) )).

%---- line(hidden - axiom656,1832644)
fof(p14,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- declaration(line(hidden - axiom656,1832644))
fof(p15,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ( ~ empty(power_set(B))
...
%---- conditional_cluster(axiom657,relation_like)
fof(p17,axiom,
    ( ! [B] :
        ( ( empty(B)
          & ilf_type(B,set_type) )
...
%---- conditional_cluster(axiom658,relation_like)
fof(p18,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- line(relset_1 - axiom662,1916330)
fof(p20,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- declaration(line(relset_1 - axiom662,1916330))
fof(p21,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- line(relset_1 - axiom663,1916334)
fof(p22,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
...
%---- declaration(line(relset_1 - axiom663,1916334))
fof(p23,axiom,
    ( ! [B] :
        ( ilf_type(B,set_type)
       => ! [C] :
