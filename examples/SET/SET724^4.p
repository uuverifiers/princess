%------------------------------------------------------------------------------
% File     : SET724^4 : TPTP v6.1.0. Released v3.6.0.
% Domain   : Set Theory
...
% Status   : Theorem
% Rating   : 0.14 v5.5.0, 0.17 v5.4.0, 0.40 v5.3.0, 0.60 v4.1.0, 0.33 v3.7.0
% Syntax   : Number of formulae    :   17 (   0 unit;   8 type;   8 defn)
%            Number of atoms       :  114 (  15 equality;  47 variable)
