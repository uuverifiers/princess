%------------------------------------------------------------------------------
% File     : SET741+4 : TPTP v6.1.0. Bugfixed v2.2.1.
% Domain   : Set Theory (Mappings)
% Problem  : Problem on composition of mappings 6
% Version  : [Pas99] axioms.
% English  : Consider three mappings F from A to B,G from B to C,H from C to A.
%            If HoGoF is injective and FoHoG and GoFoH surjective, then H is
%            one-to-one.
...
% Status   : Theorem
% Rating   : 0.96 v6.1.0, 0.97 v6.0.0, 1.00 v5.5.0, 0.96 v5.2.0, 0.95 v5.0.0, 0.96 v3.7.0, 0.95 v3.3.0, 0.93 v3.2.0, 0.91 v3.1.0, 1.00 v2.5.0, 0.88 v2.4.0, 0.75 v2.3.0, 0.67 v2.2.1
