%--------------------------------------------------------------------------
% File     : SET778-1 : TPTP v6.1.0. Released v2.5.0.
% Domain   : Set Theory
% Problem  : Set theory membership and union axioms
% Version  : [LS74] axioms.
% English  :
...
% Syntax   : Number of clauses     :   12 (   3 non-Horn;   0 unit;  10 RR)
...
%----Include Set theory membership and union axioms
