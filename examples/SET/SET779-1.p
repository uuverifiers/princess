%--------------------------------------------------------------------------
% File     : SET779-1 : TPTP v6.1.0. Released v2.5.0.
% Domain   : Set Theory
% Problem  : Set theory membership and intersection axioms
% Version  : [LS74] axioms.
% English  :
...
% Syntax   : Number of clauses     :   12 (   3 non-Horn;   0 unit;   9 RR)
...
%----Include Set theory membership and intersection axioms
