%------------------------------------------------------------------------------
% File     : SET789+4 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory (Order relations)
% Problem  : The greatest element, if it existes, is unique
...
% Status   : Theorem
% Rating   : 0.04 v6.1.0, 0.03 v6.0.0, 0.04 v5.5.0, 0.00 v5.3.0, 0.07 v5.2.0, 0.05 v5.0.0, 0.00 v4.1.0, 0.04 v3.7.0, 0.14 v3.5.0, 0.11 v3.4.0, 0.08 v3.3.0, 0.11 v3.2.0
