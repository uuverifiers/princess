%------------------------------------------------------------------------------
% File     : SET800+4 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory (Order relations)
% Problem  : Greatest lower bound of sets in total order
% Version  : [Pas05] axioms.
% English  : If an order is total, the greatest lower bound of a set is greater
%            than the greatest lower bound of a subset of it
...
% Status   : Theorem
% Rating   : 0.12 v6.1.0, 0.13 v6.0.0, 0.22 v5.5.0, 0.15 v5.4.0, 0.21 v5.3.0, 0.22 v5.2.0, 0.10 v5.0.0, 0.12 v4.1.0, 0.13 v4.0.0, 0.12 v3.7.0, 0.15 v3.5.0, 0.16 v3.4.0, 0.21 v3.3.0, 0.07 v3.2.0
