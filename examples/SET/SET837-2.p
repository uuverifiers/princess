%------------------------------------------------------------------------------
% File     : SET837-2 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Rating   : 0.30 v6.1.0, 0.50 v5.5.0, 0.70 v5.3.0, 0.67 v5.2.0, 0.56 v5.1.0, 0.65 v5.0.0, 0.50 v4.1.0, 0.54 v4.0.1, 0.55 v3.7.0, 0.30 v3.5.0, 0.36 v3.4.0, 0.50 v3.3.0, 0.57 v3.2.0
% Syntax   : Number of clauses     :   13 (   5 non-Horn;   0 unit;  10 RR)
