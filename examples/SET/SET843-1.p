%------------------------------------------------------------------------------
% File     : SET843-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Source   : [Pau06]
% Names    : Zorn__equal_succ_Union [Pau06]

% Status   : Unsatisfiable
% Rating   : 0.60 v6.1.0, 0.71 v6.0.0, 0.80 v5.5.0, 0.90 v5.3.0, 0.89 v5.2.0, 0.81 v5.1.0, 0.82 v5.0.0, 0.86 v4.1.0, 0.85 v4.0.1, 0.91 v3.7.0, 0.80 v3.5.0, 0.82 v3.4.0, 0.83 v3.3.0, 0.86 v3.2.0
% Syntax   : Number of clauses     : 1367 (  30 non-Horn; 218 unit;1279 RR)
%            Number of atoms       : 2580 ( 198 equality)
