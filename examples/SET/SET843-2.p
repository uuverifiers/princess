%------------------------------------------------------------------------------
% File     : SET843-2 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Rating   : 0.00 v6.1.0, 0.14 v6.0.0, 0.00 v5.5.0, 0.15 v5.3.0, 0.17 v5.2.0, 0.06 v5.0.0, 0.00 v4.1.0, 0.08 v4.0.1, 0.09 v4.0.0, 0.00 v3.4.0, 0.08 v3.3.0, 0.14 v3.2.0
...
%            Number of variables   :   43 (  31 singleton)
