%------------------------------------------------------------------------------
% File     : SET846-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Source   : [Pau06]
% Names    : Zorn__equal_succ_Union_simplest [Pau06]

% Status   : Unsatisfiable
% Rating   : 0.50 v6.1.0, 0.43 v6.0.0, 0.60 v5.5.0, 0.80 v5.3.0, 0.83 v5.2.0, 0.75 v5.1.0, 0.76 v5.0.0, 0.79 v4.1.0, 0.77 v4.0.1, 0.64 v4.0.0, 0.55 v3.7.0, 0.40 v3.5.0, 0.55 v3.4.0, 0.58 v3.3.0, 0.71 v3.2.0
% Syntax   : Number of clauses     : 1366 (  29 non-Horn; 219 unit;1278 RR)
%            Number of atoms       : 2577 ( 194 equality)
