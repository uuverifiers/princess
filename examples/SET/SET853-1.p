%------------------------------------------------------------------------------
% File     : SET853-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Rating   : 0.60 v6.1.0, 0.64 v6.0.0, 0.80 v5.5.0, 0.85 v5.3.0, 0.89 v5.2.0, 0.81 v5.1.0, 0.82 v5.0.0, 0.79 v4.1.0, 0.77 v4.0.1, 0.64 v4.0.0, 0.73 v3.7.0, 0.60 v3.5.0, 0.64 v3.4.0, 0.67 v3.3.0, 0.71 v3.2.0
% Syntax   : Number of clauses     : 1372 (  36 non-Horn; 222 unit;1283 RR)
%            Number of atoms       : 2601 ( 196 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   82 (   0 propositional; 1-3 arity)
%            Number of functors    :  128 (  21 constant; 0-6 arity)
%            Number of variables   : 1944 ( 212 singleton)
