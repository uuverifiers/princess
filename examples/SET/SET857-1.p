%------------------------------------------------------------------------------
% File     : SET857-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Source   : [Pau06]
% Names    : Zorn__TFin_linear_lemma2_2_simpler_3 [Pau06]

% Status   : Unsatisfiable
% Rating   : 0.90 v6.1.0, 0.93 v6.0.0, 0.90 v5.5.0, 0.95 v5.3.0, 1.00 v5.0.0, 0.93 v4.1.0, 1.00 v4.0.1, 0.91 v3.7.0, 0.90 v3.5.0, 0.91 v3.4.0, 0.92 v3.3.0, 1.00 v3.2.0
% Syntax   : Number of clauses     : 1373 (  36 non-Horn; 223 unit;1284 RR)
%            Number of atoms       : 2603 ( 195 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   82 (   0 propositional; 1-3 arity)
%            Number of functors    :  129 (  22 constant; 0-6 arity)
