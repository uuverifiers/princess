%------------------------------------------------------------------------------
% File     : SET858-2 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Rating   : 0.10 v6.1.0, 0.07 v6.0.0, 0.10 v5.5.0, 0.05 v5.4.0, 0.10 v5.3.0, 0.17 v5.2.0, 0.12 v5.1.0, 0.18 v5.0.0, 0.14 v4.1.0, 0.23 v4.0.1, 0.27 v4.0.0, 0.18 v3.7.0, 0.10 v3.5.0, 0.09 v3.4.0, 0.17 v3.3.0, 0.21 v3.2.0
% Syntax   : Number of clauses     :   11 (   5 non-Horn;   5 unit;  10 RR)
%            Number of atoms       :   33 (   2 equality)
%            Maximal clause size   :    5 (   3 average)
%            Number of predicates  :    3 (   0 propositional; 2-3 arity)
%            Number of functors    :    8 (   4 constant; 0-3 arity)
%            Number of variables   :   91 (  66 singleton)
