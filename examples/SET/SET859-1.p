%------------------------------------------------------------------------------
% File     : SET859-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Source   : [Pau06]
% Names    : Zorn__TFin_subset_linear_simpler [Pau06]

% Status   : Unsatisfiable
% Rating   : 0.10 v6.1.0, 0.00 v6.0.0, 0.10 v5.5.0, 0.35 v5.3.0, 0.33 v5.2.0, 0.31 v5.1.0, 0.35 v5.0.0, 0.29 v4.1.0, 0.23 v4.0.1, 0.27 v4.0.0, 0.09 v3.7.0, 0.10 v3.5.0, 0.09 v3.4.0, 0.17 v3.3.0, 0.36 v3.2.0
% Syntax   : Number of clauses     : 1369 (  33 non-Horn; 222 unit;1282 RR)
%            Number of atoms       : 2594 ( 195 equality)
