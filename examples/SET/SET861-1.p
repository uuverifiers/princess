%------------------------------------------------------------------------------
% File     : SET861-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Source   : [Pau06]
% Names    : Zorn__Zorn_Lemma_alt [Pau06]

% Status   : Unsatisfiable
% Rating   : 1.00 v3.2.0
% Syntax   : Number of clauses     : 1368 (  30 non-Horn; 218 unit;1279 RR)
%            Number of atoms       : 2591 ( 194 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   82 (   0 propositional; 1-3 arity)
%            Number of functors    :  129 (  19 constant; 0-6 arity)
%            Number of variables   : 1938 ( 210 singleton)
