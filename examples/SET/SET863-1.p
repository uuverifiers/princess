%------------------------------------------------------------------------------
% File     : SET863-1 : TPTP v6.1.0. Released v3.2.0.
% Domain   : Set Theory
...
% Rating   : 0.80 v6.1.0, 0.86 v6.0.0, 0.90 v5.5.0, 0.95 v5.3.0, 1.00 v5.2.0, 0.94 v5.0.0, 0.93 v4.1.0, 0.92 v4.0.1, 0.91 v3.7.0, 0.90 v3.5.0, 0.91 v3.4.0, 0.92 v3.3.0, 0.93 v3.2.0
% Syntax   : Number of clauses     : 1371 (  30 non-Horn; 225 unit;1282 RR)
%            Number of atoms       : 2589 ( 193 equality)
%            Maximal clause size   :    5 (   2 average)
%            Number of predicates  :   82 (   0 propositional; 1-3 arity)
%            Number of functors    :  131 (  23 constant; 0-6 arity)
%            Number of variables   : 1933 ( 210 singleton)
