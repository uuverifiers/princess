%------------------------------------------------------------------------------
% File     : SET961+1 : TPTP v6.1.0. Bugfixed v4.0.0.
% Domain   : Set theory
...
% Source   : [Urb06]
% Names    : zfmisc_1__t114_zfmisc_1 [Urb06]

% Status   : Theorem
% Rating   : 0.56 v6.1.0, 0.53 v6.0.0, 0.52 v5.5.0, 0.59 v5.4.0, 0.61 v5.3.0, 0.63 v5.2.0, 0.55 v5.1.0, 0.57 v5.0.0, 0.58 v4.1.0, 0.57 v4.0.0
% Syntax   : Number of formulae    :   11 (   6 unit)
%            Number of atoms       :   20 (   8 equality)
%            Maximal formula depth :    7 (   4 average)
%            Number of connectives :   13 (   4 ~  ;   2  |;   1  &)
%                                         (   3 <=>;   3 =>;   0 <=)
%                                         (   0 <~>;   0 ~|;   0 ~&)
