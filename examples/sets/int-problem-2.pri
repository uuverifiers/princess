...
size(intersect(x0sc_A, complement(x0sc_B))) +
size(intersect(x0sc_C, complement(x0sc_B))) -
size(intersect(intersect(x0sc_A, x0sc_C), complement(x0sc_B)))

 + -1 * 0) = 0) & ((x0sc_A + -1 * x1sc_A) = 0)) & ((x0sc_B + -1 * x1sc_B) = 0)) & ((x0sc_C + -1 * x1sc_C) = 0)) &
 \part[part1] (((!((size(intersect(x1sc_A, complement(x1sc_B))) + -1 * 0) = 0) & ((x1sc_A + -1 * x2sc_A) = 0)) & ((x1sc_B + -1 * x2sc_B) = 0)) & ((x1sc_C + -1 * x2sc_C) = 0)))
