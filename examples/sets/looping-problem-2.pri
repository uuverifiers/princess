...
size(intersect(union(sc_A, sc_C), complement(sc_B))) = 0

//size(intersect(sc_A, complement(sc_B))) + size(intersect(sc_C, complement(sc_B)))
// - size(intersect(intersect(sc_A, sc_C), complement(sc_B))) = 0
