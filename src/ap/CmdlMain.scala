...
object CmdlMain {
  ...
  def printGreeting = {
    ...
    println("A Theorem Prover for First-Order Logic")
    println("(" + version + ")")
    println
    println("(c) Philipp Rümmer, 2009-2015")
    println("(c) Peter Backeman, 2014-2015")
  ...
  def printOptions = {
    ...
    println(" -connection               Use Connection Tableaux  (default: None)")
    println("                             none                                (default)")
    println("                             strong                              (default)")    
    println("                             weak")    
