...
object CmdlMain {
  ...
  def proveProblem(settings : GlobalSettings,
    ...
    try {
            ...
            var rawStrategies =
            List(("10010010",31000,2200),  // 0
                 ("10001111",5000,200),    // 1
                 ("12010030",16000,400),   // 2
                 ("10011131",1000,600),    // 3
                 ("12100101",5000,4000),   // 4
                 ("11100010",1000,600),    // 5
                 ("10110041",25000,2600),  // 6
                 ("11110131",2000,2000),   // 7
                 ("00101051",7000,5000),
                 ("01100041",2000,2000),
                 ("11001031",14000,14000), // 10
                 ("01100030",13000,1800),
                 ("11010141",40000,20000),
                 ("11010011",26000,2600),
                 ("12100111",27000,200),
                 ("12010011",33000,32000), // 15
                 ("12011130",29000,13000),
                 ("11011011",4000,200),
                 ("11011011",2000,800),
                 ("11100011",19000,1400))
      /*
