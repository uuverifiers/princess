...
object CmdlMain {
  ...
  def proveProblem(settings : GlobalSettings,
    ...
    try {
            ...
            var rawStrategies =
                 List(("11100010",2000,1800),
                      ("10001111",14000,2600),
                      ("01100040",2000,1800),
                      ("11010141",22000,200),
                      ("10010020",13000,8000),
                      ("10010010",30000,10000),
                      ("00101050",10000,8000),
                      ("11001031",15000,5000),
                      ("12100040",15000,8000),
                      ("12100101",6000,1800),
                      ("11010131",28000,20000),
                      ("11011011",15000,10000),
                      ("10100110",28000,20000),
                      ("11100030",33000,20000),
                      ("11010011",30000,10000),
                      ("12010011",33000,30000),
                      ("10110040",45000,2600),
                      ("12100041",45000,2600),
                      ("12011030",45000,200),
                      ("12001130",45000,1000))
