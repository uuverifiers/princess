...
//    println(" [+-]simplifyProofs        Simplify extracted proofs                (default: +)")
  ...
  def proveProblem(settings : GlobalSettings,
    ...
    try {
            ...
            var rawStrategies =
List(
("0001105000",21000,2200),
("1111004020",19000,8000),
("1010111012",3000,2600),
("0201102000",9000,2200),
("1010110001",6000,6000),
("1101105000",4000,200),
("1010002000",50000,47000),
("1001114010",23000,400),
("0101014010",54000,40000),
("1001101002",8000,2400),
("1210102020",38000,2200),
("0201001020",24000,20000),
("0000001000",19000,19000),
("1201013000",52000,7000),
("1001101001",22000,16000),
("0010102020",5000,800),
("1011015012",13000,10000),
("0001012002",17000,3000),
("1011112000",45000,19000),
("0001105010",5000,3000))
/*
List(
