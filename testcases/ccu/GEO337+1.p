%------------------------------------------------------------------------------
% File     : GEO337+1 : TPTP v6.1.0. Released v4.1.0.
% Domain   : Geometry
% Problem  : conjunct2(397)-holds(conjunct2(397),1382,0)
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.92 v6.1.0, 0.93 v6.0.0, 0.91 v5.5.0, 0.93 v5.3.0, 0.96 v5.2.0, 0.90 v5.0.0, 0.96 v4.1.0
% Syntax   : Number of formulae    :  130 (  15 unit)
%            Number of atoms       : 1349 ( 566 equality)
%            Maximal formula depth :   46 (  13 average)
%            Number of connectives : 1377 ( 158   ~;  12   |;1081   &)
%                                         (   8 <=>; 118  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   15 (   0 propositional; 1-3 arity)
%            Number of functors    :   16 (   8 constant; 0-8 arity)
%            Number of variables   :  836 (   0 sgn; 539   !; 297   ?)
