...
(assert (and (= h2 (heap.alloc_first (heap.alloc h (AnInt x))))
             (= a2 (heap.alloc_second (heap.alloc h (AnInt x))))))
(assert (and (= h3 (heap.alloc_first (heap.alloc h2 (AnInt y))))
             (= a3 (heap.alloc_second (heap.alloc h2 (AnInt y))))))
