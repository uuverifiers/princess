%------------------------------------------------------------------------------
% File     : SYN000_2 : TPTP v5.4.0. Released v5.0.0.
% Domain   : Syntactic
% Problem  : Advanced TPTP TFF syntax without arithmetic
% Version  : Biased.
% English  : Advanced TPTP TFF syntax that you will encounter some time.
...
%            Number of predicates  :   15 (  12 propositional; 0-2 arity)
%            Number of functors    :    6 (   4 constant; 0-2 arity)
%            Number of variables   :   17 (   0 sgn;  13   !;   1   ?)
    ...
    ! [X: $i] :
      $let_ff(
        ...
        , ( q($let_tt(! [Z1: $i] : f(Z1) = g(Z1,b), f(a)),X)
          & p($let_ft(! [Y3: $i] : q(Y3,Y3) <=> q(a,a), $ite_t(q(b,b), f(a), f(X)))) ) ) )).
